...
const PROJECT_JOBS: {
...
}[] = [
  {
    ...
    variants: {
      male: { url: "/avatars/rocketbox-male-casual-student.vrm", match: "closest", note: "현실형 일상복 · 전신 추적 중심 · 얼굴 표정 일부 제한", source: "rocketbox" },
      female: { url: "/avatars/rocketbox-female-casual-student.vrm", match: "closest", note: "현실형 일상복 · 전신 추적 중심 · 얼굴 표정 일부 제한", source: "rocketbox" },
    },
  },
  {
    ...
    variants: {
      male: { url: "/avatars/rocketbox-male-pilot-for-astronaut.vrm", match: "closest", note: "현실형 파일럿 기반 · 전신 추적 중심 · 얼굴 표정 일부 제한", source: "rocketbox" },
      female: { url: "/avatars/rocketbox-female-pilot-for-astronaut.vrm", match: "closest", note: "현실형 파일럿 기반 · 전신 추적 중심 · 얼굴 표정 일부 제한", source: "rocketbox" },
    },
  },
  {
...
export function ControlPanel({ engine }: { engine: Engine }) {
  ...
  s.vrmUrl?.startsWith("/avatars/valid-") ||
    s.vrmUrl?.startsWith("/avatars/rocketbox-"),
);
